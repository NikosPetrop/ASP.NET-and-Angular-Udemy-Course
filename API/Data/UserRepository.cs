...
/// <summary> This is an abstraction layer (Repository pattern) to our DataContext. </summary>
public class UserRepository : IUserRepository
{
    ...
    public async Task<AppUser> GetUserByUsernameAsync(string username) => await _context.Users.Include(p => p.Photos).SingleOrDefaultAsync(x => x.UserName == username);
